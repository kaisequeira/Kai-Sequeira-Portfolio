...
const Projects: React.FC = () => {
  return (
    <div className="flex flex-col w-screen min-h-fit justify-center items-center bg-bgr gap-12 pb-1/14 pt-14 relative">
      ...
      <div className='flex 2xl:flex-row 2xl:w-[1350px] 2xl:gap-14 gap-8 lg:w-[800px] flex-col w-[350px]'>
        <ProjectPane colour="var(--gradient-acc2)" className="flex flex-col items-center 2xl:h-[50vh] h-[70vh] 2xl:w-1/4 w-full" title="This Website" note="Learn more...">
          {/* Add your image or content here */}
        </ProjectPane>
