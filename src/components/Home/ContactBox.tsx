...
import { faFileArrowDown, faEnvelope, faAddressCard, faSquareArrowUpRight, faPaste, faCircleCheck, faUser } from '@fortawesome/free-solid-svg-icons';
...
const ContactBox: React.FC<ContactBoxProps> = ({ type }) => {
    ...
    switch (type) {
        case "Github":
            ...
            onClick = () => setTimeout(() => window.open('https://github.com/kaisequeira', '_blank'), 300);
            break;
        case "LinkedIn":
            icon = <FontAwesomeIcon className='size-5/12 text-offwhite' icon={faLinkedinIn} />;
            actionIcon = faSquareArrowUpRight;
            color = 'var(--gradient-acc1)';
            onClick = () => setTimeout(() => window.open('https://www.linkedin.com/in/kai-sequeira-3b49602ba/', '_blank'), 300);
            break;
        case "Resume":
            ...
            onClick = () => setTimeout(() => window.open('/KaiSequeiraResume.pdf', '_blank'), 300);
            break;
        case "Email":
            ...
            break;
        case "About":
            icon = <FontAwesomeIcon className='size-5/12 text-offwhite' icon={faUser} />;
            actionIcon = faSquareArrowUpRight;
